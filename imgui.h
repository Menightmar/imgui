...
struct ImFontAtlas
{
	...
	static IMGUI_API const ImFontBuilderIO * Generador_IO; // Usaremos esto para pruebas.
	...
	static IMGUI_API bool		Initialize (bool UseFreetype = true);				// Inicia el loader de fuente.
